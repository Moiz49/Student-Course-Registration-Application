...
/**
 * this class is similar to our data base class, as it adds and creates all of
 * the course offering for our courses and the students. The server talks to
 * this class which controls everything happening in the back end.
 * 
