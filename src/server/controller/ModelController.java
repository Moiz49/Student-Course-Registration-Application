...
/**
 * This class communicates with the server model.
 * 
...
public class ModelController implements Runnable {
	 ...
	 * @throws IOException.
	 */
	public ModelController(Socket s, ServerController server, Model model) throws IOException {
		socket = s;
	...
	/**
	 * Calls the appropriate methods of Model based on input and returns output to
	...
	public void run() {
		while (true) {
			...
			case 2:
				model.addCourse(input.get(1), input.get(2), Integer.parseInt(input.get(3)),
			...
			case 6:
				...
				case 3:
					...
					break;
				case 5:
					communicate(model.canEnroll(input.get(2), input.get(3), Integer.parseInt(input.get(4)),
